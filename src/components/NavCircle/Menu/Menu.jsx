...
import raymLogoWhite from "../../../assets/raymW.png";
    ...
    <div className="menu-body" id='top'>
      <header className="header__content p-4">
        <a href="/" className="logo-container">
          {isDarkMode ? (
            <img src={raymLogoWhite} alt="Logo Raym" className="logo" />
          ) : (
            <svg
              version="1.0"
        ...
        <div className="icons-container">
          ...
          <button
            ref={buttonRef}
            className={`header__button nav-btn-js ${isRevealed ? "open" : ""} ${isDarkMode ? "dark-mode" : ""}`}
            type="button"
        ...
        <ul>
          ...
          {isLoggedIn && (
            <>
              ...
              <li className="header__menu-item">
                <a
                  href="/my_account"
                  onClick={(e) => handleMenuItemClick(e, "/my_account")}
                >
                  <FontAwesomeIcon
                    icon={faAddressCard}
                    className={`${
          ...
          {isAdmin && (
            <li className="header__menu-item">
              <a
                href="/admin"
                onClick={(e) => handleMenuItemClick(e, "/admin")}
              >
                <FontAwesomeIcon
                  icon={faAddressCard}
                  className={`${
      ...
      >
        <section className="clip-text-video" style={{ overflow: "hidden" }}>
          ...
          >
            <source src={mtbVideo} type="video/mp4" />
          </video>
        ...
        <ul className="header__menu">
          <li className="header__menu-item">
            <a href="/" onClick={(e) => handleMenuItemClick(e, "/")}>
              Accueil
            </a>
          </li>
          <li className="header__menu-item">
            <a href="/brand" onClick={(e) => handleMenuItemClick(e, "/brand")}>
              La marque
            </a>
          </li>
          <li className="header__menu-item">
            <a href="/shop" onClick={(e) => handleMenuItemClick(e, "/shop")}>
              Boutique
            </a>
          </li>
          <li className="header__menu-item">
            <a
              href="/configurator"
              onClick={(e) => handleMenuItemClick(e, "/configurateur")}
            >
              Configurateur
            </a>
          </li>
          <li className="header__menu-item">
            <a
              href="/maintenance"
              onClick={(e) => handleMenuItemClick(e, "/maintenance")}
            >
              Entretien
            </a>
          </li>
      ...
      >
        <>
          <p>
            {isAdmin
              ? "Vous êtes administrateur: vous n'avez pas de panier!"
