...
import { isAuthAtom, productsAtom} from "../../app/atoms";
import { useEffect } from "react";
// import '../../index.css'; // Import des styles CSS personnalisés

const DualCarousel = ({allProducts}) => {
    ...
    "On Road": [
      {
        ...
        name: "On Road - Velo1",
        price: 100,
        image: "src/assets/RAYM_on_road-Raym.png",
      },
      {
        id: 2,
        name: "On Road - Velo2",
        price: 150,
        image: "src/assets/RAYM_on_road-Annie.png",
      },
      {
        id: 3,
        name: "On Road - Velo3",
        price: 200,
        image: "src/assets/RAYM_on_road-Robena.png",
      },
      {
        id: 4,
        name: "On Road - Velo4",
        price: 200,
        image: "src/assets/RAYM_on_road-Malo.png",
      },
    ],
    "Off Road": [
      {
        ...
        name: "Off Road - Velo1",
        price: 120,
        image: "src/assets/VELO6RAPTOR-Raym.png",
      },
      {
        id: 6,
        name: "Off Road - Velo2",
        price: 170,
        image: "src/assets/VELO6RAPTOR-Annie.png",
      },
      {
        id: 7,
        name: "Off Road - Velo3",
        price: 220,
        image: "src/assets/VELO6RAPTOR-Robena.png",
      },
      {
        id: 8,
        name: "Off Road - Velo4",
        price: 220,
        image: "src/assets/VELO6RAPTOR-Malo.png",
      },
    ],
    Hybride: [
      {
        ...
        name: "Hybride - Velo1",
        price: 130,
        image: "src/assets/RAYM_Hybrid-Raym.png",
      },
      {
        id: 10,
        name: "Hybride - Velo2",
        price: 180,
        image: "src/assets/RAYM_Hybrid-Annie.png",
      },
      {
        id: 11,
        name: "Hybride - Velo3",
        price: 230,
        image: "src/assets/RAYM_Hybrid-Robena.png",
      },
      {
        id: 12,
        name: "Hybride - Velo4",
        price: 235,
        image: "src/assets/RAYM_Hybrid-Malo.png",
      },
    ],
    Homme: [
    ...
    Femmes: [
      {
        ...
        name: "Tenue Femme 1",
        price: 120,
        image: "src/assets/RAYM_-F-_Annie.png",
      },
      {
        id: 16,
        name: "Tenue Femme 2",
        price: 170,
        image: "src/assets/RAYM_-F-_Raym.png",
      },
    ],
  };
  ...
  const sliderSettings = {
    ...
    afterChange: (current) => {
      if (selectedBikeCategory) {
        const bikeSelection = allProducts.filter(product =>{
            product.category.name == selectedBikeCategory
        })
        setSelectedBikeProduct(bikeSelection[current]);
      }
      if (selectedClothingCategory) {
        const clothingSelection = allProducts.filter(product =>{
            product.category.name == selectedClothingCategory
        })
        setSelectedClothingProduct(clothingSelection[current]);
      }
    },
  };

  useEffect(()=>{
    if (selectedBikeCategory && allProducts) {
        const bikeSelection = allProducts.filter(product =>{
            product.category.name == selectedBikeCategory
        })
        console.log(bikeSelection)
        setSelectedBikeProduct(bikeSelection);
      }
  }, [selectedBikeCategory])

  console.log(selectedBikeProduct);
                ...
                <>
                  ...
                  {selectedClothingProduct && (
                    <div className="flex flex-col justify-center">
                      <button
                        className="px-3 py-1 mt-2 text-white bg-blue-500 rounded-sm sm:rounded"
                        onClick={() => handleAddToCart(selectedClothingProduct)}
                      >
