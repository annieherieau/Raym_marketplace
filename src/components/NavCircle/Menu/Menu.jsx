...
import logo from "../../../assets/raymB.svg";
...
const Navbar = () => {
  ...
  <svg version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 908 302" preserveAspectRatio="xMidYMid meet" class="logo" >
  <g id="logo-content" transform="translate(0,302) scale(0.1,-0.1)" fill="#000000" stroke="none">
