...
const ColorsList = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg">
      <h3 className="text-2xl font-semibold mb-4 text-black">Liste des Couleurs</h3>
      <form onSubmit={handleSubmit} className="mb-6">
        ...
        <div className="mb-4">
          <label className="block text-black text-sm font-bold mb-2">Collection:</label>
          <input
            type="text"
            name="collection"
      ...
      <ul className="space-y-4">
        {colors.map(color => (
          <li key={color.id} className="border-b pb-4">
            <h4 className="text-xl text-black">{color.name}</h4>
            <p className="text-black">Collection: {color.collection}</p>
