                ...
                <div className="flex flex-wrap md:-m-2 -m-1">
                    <div className="flex flex-wrap w-1/2">
                        <div className="md:p-2 p-1 w-full">
                            <img alt="gallery" className="w-full h-full object-cover object-center block" src={tdfImage} style={{ borderRadius: '20px' }} />
                        </div>
                    ...
                    <div className="flex flex-wrap w-1/2">
                        ...
                        <div className="md:p-2 p-1 w-full">
                            <img alt="gallery" className="w-full h-full object-cover object-center block" src={teamLabImage} style={{ borderRadius: '20px' }} />
                        </div>
                    </div>
                </div>
            </div>
